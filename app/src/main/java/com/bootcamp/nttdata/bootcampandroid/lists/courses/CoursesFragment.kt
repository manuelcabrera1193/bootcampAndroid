 ...
 */
class CoursesFragment : Fragment(), EventsItem {

    private var columnCount = 1

    val adaptador = ListCourseAdapter(this)
    ...
    override fun onCreateView(
        ...
        for (item in 1..20) {
            courses.add(Course(item.toString(), "manuel", "cabrera"))
        }
    ...
    override fun deleteItem(id: Int) {
        ...
        val newList = currentList.filter { it.id.toInt() != id }.toList()
        adaptador.submitList(newList)
    }
}